            ...
            <div id='formation'>
                <p className='divTitle'>Formação</p>
                    ...
                    <div id="divLi">
                        ...
                        <li><p>Proposta de conclusão de curso: <a target='_blank' href="https://marcosamaris.github.io/laws/#/">"Laws - Ferramenta de anotação para gravações de midias!"</a></p></li>
                    </div>
                    <div id="divImg">
